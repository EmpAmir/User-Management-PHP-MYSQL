...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE users SET name=(:name), user_name=(:user_name), mobile=(:mobileno) WHERE id=(:idedit)";
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">user_name<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="user_name" name="user_name" class="form-control" required value="<?php echo htmlentities($result->user_name); ?> " readonly>
													</div>
												</div>
