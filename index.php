...
if (isset($_POST['login'])) {
	...
	$sql = "SELECT user_name,password FROM users WHERE user_name=:user_name and password=:password and status=(:status)";
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<label for="" class="text-uppercase text-sm">Your user_name</label>
