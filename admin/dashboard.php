											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 ">$<?php echo htmlentities($total_usdt); ?></div>
														<div class="stat-panel-title text-uppercase">Total Buy USDT</div>
													</div>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-danger text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 "> ₹<?php echo htmlentities($total_inr); ?></div>
														<div class="stat-panel-title text-uppercase">Total Buy INR</div>
													</div>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 "> ₹<?php echo htmlentities($total_inr_sell); ?></div>
														<div class="stat-panel-title text-uppercase">Total Transfer INR</div>
													</div>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 "> ₹<?php echo htmlentities($remaining); ?></div>
														<div class="stat-panel-title text-uppercase">Total Rem Balance</div>
													</div>
												</div>
												<a href="deleteduser.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
