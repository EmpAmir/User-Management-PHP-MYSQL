											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><a href="../index.php" target="_blank"><?php echo htmlentities($result->user_name); ?></a>
														</td>
														<td><?php echo htmlentities($result->mobile); ?></td>
														<!-- <td>
															<a href="edit-user.php?edit=<?php echo $result->id; ?>" onclick="return confirm('Do you want to Edit');" disabled>&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
